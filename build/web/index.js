...
var ASM_CONSTS = {
  92792: () => { if (document.fullscreenElement) return 1; },  
 92838: () => { return document.getElementById('canvas').width; },  
 92890: () => { return parseInt(document.getElementById('canvas').style.width); },  
 92958: () => { document.exitFullscreen(); },  
 92985: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93058: () => { if (document.fullscreenElement) return 1; },  
 93104: () => { return document.getElementById('canvas').width; },  
 93156: () => { return screen.width; },  
 93181: () => { document.exitFullscreen(); },  
 93208: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93341: () => { return window.innerWidth; },  
 93367: () => { return window.innerHeight; },  
 93394: () => { if (document.fullscreenElement) return 1; },  
 93440: () => { return document.getElementById('canvas').width; },  
 93492: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93560: () => { if (document.fullscreenElement) return 1; },  
 93606: () => { return document.getElementById('canvas').width; },  
 93658: () => { return screen.width; },  
 93683: () => { return window.innerWidth; },  
 93709: () => { return window.innerHeight; },  
 93736: () => { if (document.fullscreenElement) return 1; },  
 93782: () => { return document.getElementById('canvas').width; },  
 93834: () => { return screen.width; },  
 93859: () => { document.exitFullscreen(); },  
 93886: () => { if (document.fullscreenElement) return 1; },  
 93932: () => { return document.getElementById('canvas').width; },  
 93984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94052: () => { document.exitFullscreen(); },  
 94079: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94137: () => { return screen.width; },  
 94162: () => { return screen.height; },  
 94188: () => { return window.screenX; },  
 94215: () => { return window.screenY; },  
 94242: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94295: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94366: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94423: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94679: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 94750: () => { if (document.fullscreenElement) return 1; },  
 94796: () => { return window.innerWidth; },  
 94822: () => { return window.innerHeight; },  
 94849: () => { if (document.pointerLockElement) return 1; }
};
