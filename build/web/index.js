...
var ASM_CONSTS = {
  92872: () => { if (document.fullscreenElement) return 1; },  
 92918: () => { return document.getElementById('canvas').width; },  
 92970: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93038: () => { document.exitFullscreen(); },  
 93065: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93138: () => { if (document.fullscreenElement) return 1; },  
 93184: () => { return document.getElementById('canvas').width; },  
 93236: () => { return screen.width; },  
 93261: () => { document.exitFullscreen(); },  
 93288: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93421: () => { return window.innerWidth; },  
 93447: () => { return window.innerHeight; },  
 93474: () => { if (document.fullscreenElement) return 1; },  
 93520: () => { return document.getElementById('canvas').width; },  
 93572: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93640: () => { if (document.fullscreenElement) return 1; },  
 93686: () => { return document.getElementById('canvas').width; },  
 93738: () => { return screen.width; },  
 93763: () => { return window.innerWidth; },  
 93789: () => { return window.innerHeight; },  
 93816: () => { if (document.fullscreenElement) return 1; },  
 93862: () => { return document.getElementById('canvas').width; },  
 93914: () => { return screen.width; },  
 93939: () => { document.exitFullscreen(); },  
 93966: () => { if (document.fullscreenElement) return 1; },  
 94012: () => { return document.getElementById('canvas').width; },  
 94064: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94132: () => { document.exitFullscreen(); },  
 94159: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94217: () => { return screen.width; },  
 94242: () => { return screen.height; },  
 94268: () => { return window.screenX; },  
 94295: () => { return window.screenY; },  
 94322: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94375: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94446: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94503: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94759: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 94830: () => { if (document.fullscreenElement) return 1; },  
 94876: () => { return window.innerWidth; },  
 94902: () => { return window.innerHeight; },  
 94929: () => { if (document.pointerLockElement) return 1; }
};
